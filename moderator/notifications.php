...
<body>
	...
	<?php 
		...
		if($user->is_loggedin()){
			...
			$stmt = $DB_con->prepare("SELECT * from notifications where user_to_id=:user_id and user_from_id !=:user_id");
			...
			while($notifications_row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<section class='notification'>";
				echo "<a href='user_profile.php?user_id=$user_from_id'><img src='images/$image'>@" . $user_name . "</a>" . " " . $notification . " " . "<span>".  $time ."</span>" ."<br/>";
				echo "</section>";
			}
		}
