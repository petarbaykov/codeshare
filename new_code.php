				...
				<div class="editor-area">
					...
					<div class="fields">
					 	 ...
					 	 <div class="tab-panels">
						    ...
						    <ul class="tabs">
						      	<li rel="html" class="active-tab"><a data-toggle="modal" data-target="#html-settings"><i class="fa fa-cog"></i></a>  index.html <i class="fa fa-times cls-html"></i></li>
						       	<li rel="css" ><a  data-toggle="modal" data-target="#css-settings"><i class="fa fa-cog"></i></a>  style.css <i class="fa fa-times cls-css"></i></li>
						        <li rel="js"  class="last"><a  data-toggle="modal" data-target="#js-settings"><i class="fa fa-cog"></i></a>  app.js <i class="fa fa-times cls-js"></i></li>
					    	</ul>
 ...
 <div class="modal fade" id="settings" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<script type="text/javascript">
		$('.cls-js').click(function(){
			$('.cls-js').parent().addClass('hidden');
			
		});
		$('.cls-css').click(function(){
			$('.cls-css').parent().addClass('hidden');
			
		});
		$('.cls-html').click(function(){
			$('.cls-html').parent().addClass('hidden');
