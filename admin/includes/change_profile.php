...
<form action="edit_profile.php?id=<?php echo $user_id ?>" method="post" enctype="multipart/form-data">
				...
				<div class="input-group">
				<label for="user_image">Снимка</label>
  					<input type="file" name="user_image" class="form-control" >
				</div>
				<div class="input-group">
				
  					<input type="submit" name="change_profile" class="btn btn-success" value="Редактиране" >
				</div>
				<?php  
					if(isset($_POST['change_profile'])){
						...
						if($image == ""){
		 				...
		 				echo "<script>window.opne('edit_profile.php?id=$user_id', '_self')</script>";
					}
				?>
</form>